...
train_data_dir = 'Data/Total/train_data'
val_data_dir='Data/Total/val_data'
test_data_dir='Data/Total/test_data'
...
filepath = 'ModelCheckpoints/checkpoint-{epoch:02d}-{val_loss:.02f}.hdf5'
...
model.fit(train_data,epochs=20,validation_data=val_data,callbacks=[tensorboard_callbacks,checkpoint])
